...
* GitHub Issues: <https://github.com/wsssoftware/cakephp-web-socket/issues>
...
* wsssoftware/cakephp-web-socket follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  wsssoftware/cakephp-web-socket automatically runs tests for pull requests. However,
...
[github]: https://github.com/wsssoftware/cakephp-web-socket
[issues]: https://github.com/wsssoftware/cakephp-web-socket/issues
[pull requests]: https://github.com/wsssoftware/cakephp-web-socket/pulls
